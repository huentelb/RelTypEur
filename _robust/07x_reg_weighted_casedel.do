...
use $WD/data/USA_lc_casedel.dta, clear
...
recode class (5=1)(2=2)(3=3)(1=4)(4=5)
...
save $WD/data/lc_analytical_casedel.dta, replace
...
use $WD/data/lc_analytical_casedel.dta, clear
...
est store mlogit_l
outreg2 using $M/mlogit_l_casedel.doc, label stats(coef se) aster() ///
