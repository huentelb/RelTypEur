...
save_as_docx(ftab, path = paste0(folder.graph.model,"avepp_",kin.l,".docx"))
...
# Class labels
class.lab <- as.character(c("Ambivalent",
                            "Distant", 
                            "Close",
                            "Conflicted"))

class.lab.p <- as.character(c(paste0("Ambivalent (", post[1,2], "%)"),
                            paste0("Distant (", post[2,2], "%)"),
                            paste0("Close (", post[3,2], "%)"),
                            paste0("Conflicted (", post[4,2], "%)")))
...
ggplot(lcmodel,aes(x = L2, y = value, fill = Var2)) + 
  ...
  scale_x_discrete(labels = c("sup_lca" = "Support",
                              ...
                              "mon_lca" = "Money",
                              "tra_lca" = "Proximity"),
                   limits = c("sup_lca", "cnt_lca", "clo_lca", "cnf_lca", "mon_lca", "tra_lca")) +
  theme(
